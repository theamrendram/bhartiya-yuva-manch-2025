...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative min-h-[calc(100vh-100px)] !pb-5 pt-24 py-8 md:py-24 lg:py-32"
      id="hero"
    >
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="animate-pulse-slow absolute -top-32 left-1/2 h-[60vh] w-[120vw] -translate-x-1/2 opacity-70 blur-3xl" />
      </div>
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-4 md:px-6">
        ...
        >
          <div className="space-y-3 md:space-y-4">
            <h1 className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-3xl md:py-2 sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-transparent drop-shadow-lg">
            ...
            <p className="mx-auto max-w-2xl text-base sm:text-lg md:text-xl font-medium text-gray-300">
              ...
              Empowering professionals with knowledge, innovation, and future-ready skills.
            </p>
          </div>
